...
# download = gis.search(search_params=_search_params, path_to_dir='/static/images')

# print(download)
# # # this will search, download and resize:
# # gis.search(search_params=_search_params, path_to_dir='/static', width=500, height=500)
